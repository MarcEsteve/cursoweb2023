...
CREATE TABLE PRODUCTOS(CÓDIGOARTÍCULO VARCHAR(60),SECCIÓN VARCHAR(60),NOMBREARTÍCULO VARCHAR(60),PRECIO DOUBLE,FECHA VARCHAR(60),IMPORTADO VARCHAR(60),PAÍSDEORIGEN VARCHAR(60),FOTO VARCHAR(60));
-- Insertar registros
