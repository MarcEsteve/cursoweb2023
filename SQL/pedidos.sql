CREATE TABLE PEDIDOS(NÚMERO_DE_PEDIDO DOUBLE,CÓDIGO_CLIENTE VARCHAR(10),FECHA_DE_PEDIDO VARCHAR(10),FORMA_DE_PAGO VARCHAR(10),DESCUENTO DOUBLE,ENVIADO VARCHAR(10));
